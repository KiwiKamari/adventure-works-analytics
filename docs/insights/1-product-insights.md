# Product Profitability & Cost Analysis — Business Insights

<p align="center">
<img width="55%" height="55%" alt="product_details" src="https://github.com/user-attachments/assets/fded818b-c4d0-4c7c-98e8-00968f184c6c" />
</p>

## Revenue Concentration Across Product Categories

The analysis reveals a strong revenue concentration within the Bikes category, which dominates overall sales volume compared to the remaining product groups.

This indicates that the business depends heavily on core bicycle products as its primary revenue driver.

At the same time, high revenue concentration also implies higher exposure to category-specific demand fluctuations.

---

## Cost Structure & Profitability Efficiency

<p align="center">
<img width="25%" height="25%" alt="image" src="https://github.com/user-attachments/assets/283c8ad1-9ca9-404f-bafc-ecab1b6eba72" />
</p>

Although Bikes generate the largest share of revenue, they also accumulate the highest operational costs.

The dashboard shows that revenue leadership does not always translate into superior profitability efficiency.

Some lower-volume categories demonstrate healthier margin behavior relative to their size.

### Key Findings

- High-revenue categories may operate with thinner margins.
- Smaller categories can contribute disproportionately strong profitability efficiency.
- Revenue alone is insufficient to evaluate business performance accurately.

---

## Product Pricing vs Margin Behavior

<p align="center">
<img width="45%" height="45%" alt="image2" src="https://github.com/user-attachments/assets/3e378015-2833-4a3c-92d6-185a4ff32286" />
</p>

The relationship between product pricing and profitability is not strictly linear.

The scatter analysis suggests that premium-priced products do not necessarily achieve the highest margins, while several mid-priced products maintain stronger profitability ratios.

### Key Findings

- Higher prices do not automatically guarantee higher margin performance.
- Margin dispersion exists across multiple pricing segments.
- Certain mid-range products appear operationally more efficient than premium products.

---

## Profitability Concentration at Product Level

<p align="center">
<img width="45%" height="45%" alt="image3" src="https://github.com/user-attachments/assets/9edf3df0-abf9-4fa6-9183-67a15caa38df" />
</p>

The Top 10 Products analysis indicates that profit generation is concentrated among a relatively small subset of products.

This suggests that a limited number of SKUs are responsible for a significant portion of total business profitability.

### Key Findings

- Product profitability is unevenly distributed.
- A small group of products drives a large portion of total profit.
- Not all high-selling products contribute equally to profitability.

---

## Subcategory Margin Distribution

<p align="center">
<img width="35%" height="35%" alt="image4" src="https://github.com/user-attachments/assets/50ecc65d-96d3-44ec-91dc-7a0bd91cbedc" />
</p>

The treemap visualization highlights major differences in margin performance across subcategories.

Products within the same parent category can behave very differently in terms of operational profitability.

### Key Findings

- Profitability distribution varies significantly between subcategories.
- Product hierarchy alone is not enough to evaluate performance.
- Some subcategories maintain stronger margin efficiency despite lower sales volume.

---

## Historical Cost Tracking Impact

<p align="center">
<img width="55%" height="55%" alt="image5" src="https://github.com/user-attachments/assets/a6ec32d1-9a2e-4c1d-bc8d-67bb104670b4" />
</p>

The integration of historical production costs provides a more accurate profitability model compared to static cost assumptions.

By matching product costs to the closest valid historical period, the analysis reflects more realistic operational conditions over time.

### Key Findings

- Historical cost matching improves profit accuracy.
- Margin calculations become more reliable across time periods.
- Product profitability evolves dynamically alongside cost changes.# adventure-works-analytics (SQL Server + Power BI)
